...
const StatusMessage = ({ message, type }) => {
    ...
    let baseClasses = "fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50 px-6 py-3 rounded-full shadow-xl font-medium text-sm transition-all duration-300 flex items-center space-x-2";
